    ...
    <main>
          ...
          <div className="mt-14 grid gap-4 md:grid-cols-3">
            {mvv.map((m) => (
              <div key={m.label} className="group relative flex flex-col overflow-hidden rounded-2xl border border-border bg-ink-2 p-8 hover:border-brd hover:shadow-xl hover:-translate-y-1 transition">
                ...
                <p className="mt-6 text-sm text-foreground/70 leading-relaxed whitespace-pre-line flex-1">
                  {m.desc}
                </p>
              </div>
            ))}
      ...
      <section className="py-20 md:py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          />
          <div className="mt-14 grid grid-cols-2 md:flex md:flex-row md:justify-between gap-6 md:gap-4 lg:gap-8">
            {processo.map((p, idx) => (
              <div key={p.step} className="relative md:flex-1">
                ...
                <div className="group relative z-10 flex flex-col items-center text-center">
                  <div className="relative flex h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 items-center justify-center rounded-xl sm:rounded-2xl md:rounded-3xl bg-ink-2 border border-border shadow-lg group-hover:border-brd group-hover:shadow-brd/20 transition-all duration-500 overflow-hidden">
                    ...
                    <div className="relative font-display text-2xl sm:text-3xl md:text-4xl font-black text-brd group-hover:text-gold transition-colors">
                      {p.step}
                    </div>
                  </div>
                  <div className="mt-4 md:mt-8">
                    <h3 className="font-display text-sm sm:text-base md:text-lg font-bold group-hover:text-brd transition-colors line-clamp-2 min-h-[2.5rem] md:min-h-0">{p.title}</h3>
                    <p className="mt-2 md:mt-4 text-[10px] sm:text-xs md:text-sm text-foreground/70 leading-relaxed mx-auto max-w-full md:max-w-[240px]">
                      {p.desc}
                    </p>
                  </div>
                  <div className="mt-4 md:mt-6 grid h-7 w-7 sm:h-8 sm:w-8 md:h-10 md:w-10 place-items-center rounded-lg md:rounded-xl bg-gold/10 text-brd group-hover:bg-brd group-hover:text-gold transition-all">
                    <p.icon className="h-3.5 w-3.5 sm:h-4 w-4 md:h-5 md:w-5" />
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {grupo.map((g) => (
              ...
              >
                ...
                <div className="mt-8 flex items-center justify-between border-t border-brd/10 pt-6">
